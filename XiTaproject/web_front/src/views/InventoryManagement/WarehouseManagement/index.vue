<template>
  <!-- 出库管理 -->
  <div id="WarehouseManagement-box">
    <div class="WarehouseManagement-header">
      <div class="WarehouseManagement-header-left">
        <el-input
          v-model="valueInput"
          placeholder="输入物品名称"
          class="WarehouseManagement-header-input"
        >
        </el-input>
        <el-date-picker
          v-model="valueData"
      ...
      <div class="WarehouseManagement-header-right">
        ...
        <div>
          ...
          >
            ...
            >
              ...
              <el-form-item label="领取人" prop="nursingid">
                <el-select
                  placeholder="请输入领取人"
                  style="width: 100%"
                  v-model="ruleForm.nursingid"
                >
                  <el-option
                    v-for="item in getnursingidData"
                    :key="item.id"
                    :label="item.nickname"
                    :value="item.id"
                  ></el-option>
            ...
            <span slot="footer" class="WarehouseManagement-dialog-footer">
    ...
    <div class="WarehouseManagement-content">
      <el-table
        :data="
    ...
    <div class="WarehouseManagement-block">
      <el-pagination
...
export default {
  data() {
    return {
      ...
      rules: {
        ...
        norms: [{ required: true, message: "请选择物品种类", trigger: "blur" }],
        materialid: [
          { required: true, message: "请选择物品种类", trigger: "blur" },
        ],
        nursingid: [
  ...
  methods: {
    ...
    getNursingUserList() {
      ...
      this.$ajax
        .post(
          process.env.API_HOST + "/sysNursingUser/getNursingUserList",
          `search=${JSON.stringify(nickname)}`
        )
        .then((respones) => {
          this.getnursingidData = respones.data;
        });
    },
        ...
        if (valid) {
          this.$http
            .insertMaterialDelivery({
              ...
              nursingid: this.ruleForm.nursingid,
    ...
    handleUserList() {
      ...
      this.$http.getMaterialDeliveryList(formData).then((res) => {
...
.WarehouseManagement-header-input {
  width: 250px;
}
.WarehouseManagement-header-left {
  width: 750px;
  float: left;
}
.WarehouseManagement-header-right {
  float: right;
}
.selectel-select {
  width: 140px;
