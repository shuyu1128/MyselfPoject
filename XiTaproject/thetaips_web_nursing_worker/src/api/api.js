...
export default {
    ...
    // 修改密码
    updateNursingUserPassword(params) {
        return http.post(`nursing/sysNursingUser/updateNursingUserPassword`, params)
    },
    // 获取账户信息
    getUser(params) {
    ...
    //添加护工物料使用信息
    insertNursingMaterialUsageDetails(params){
        return http.post(`/nursing/nursingMaterialInformation/insertNursingMaterialUsageDetails`, params)
    },
    //查询
    getMaterialInformationListByMaterialname(params){
        return http.post(`/nursing/nursingMaterialInformation/getMaterialInformationListByMaterialname`, params)
    }
}