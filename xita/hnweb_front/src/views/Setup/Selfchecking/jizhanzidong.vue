  ...
  <div>
    ...
    <el-dialog title="详情" :visible.sync="dialogTableVisible">
      <el-table height="241" border :data="xqdata">
        <el-table-column align="center" property="dataname" label="设备名称"></el-table-column>
        <el-table-column align="center" property="datacode" label="设备编码"></el-table-column>
        <el-table-column align="center" property="rssi" label="rssi"></el-table-column>
  ...
  methods: {
      ...
      this.$ajax
        .post(
          process.env.API_HOST +
            "/selfExamination/getBasestationSelfExaminationP"
        )
        .then((response) => {
      ...
      if (this.value) {
        ...
        this.$ajax
          .post(
            ...
            `beginTime=${currentdate}&cycle=${this.value}&unit=${this.Company}&type=basestation`
          )
          .then((response) => {
    ...
    Manual() {
      ...
      this.$ajax
        .post(
          process.env.API_HOST +
            "/selfExamination/getBasestationSelfExamination"
        )
        .then((response) => {
          if (response.data == "success") {
            this.$message({
