  ...
  <div class="worker_list">
    ...
    <el-table border :data="nursingWorkList" style="width: 100%">
      <el-table-column align="center" label="护工审核表">
        ...
        <el-table-column align="center" prop="doing" label="应做工时">
        </el-table-column>
        <el-table-column align="center" prop="done" label="已做工时">
        </el-table-column>
        <el-table-column align="center" prop="approved" label="审批工时">
        </el-table-column>
        <el-table-column
          align="center"
          prop="approvalFailed"
