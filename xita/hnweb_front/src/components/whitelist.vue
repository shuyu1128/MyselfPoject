...
this.$ajax
      .post(
        process.env.API_HOST +
          "/mainBasestation/insertMainChildWhiteBasestation",`mainBasestationCode=${this.mainBasestationCodevalue}&basestationCodes=${JSON.stringify(this.basestationCodesvalue)}`
      )
      .then(respones => {
 ...
 this.$ajax
      .post(
        process.env.API_HOST +
          "/mainBasestation/getChildWhiteBasestationByMain",`mainBasestationCode=${this.mainBasestationCodevalue}`
      )
      .then(respones => {
